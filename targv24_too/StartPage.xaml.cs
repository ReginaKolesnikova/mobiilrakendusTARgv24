...
{
	public List <ContentPage> lehed= new List<ContentPage>() { new TekstPage(), new FigurePage(), new TimerPage(), new DateTimePage, new NäidisPage_lumi(), new GridPage()};
	public List<string> tekstid= new List<string>() { "Tee lahti leht Text'iga", "Tee lahti Figure leht", "Tee lahti Timer leht", "Tee lahti DateTime leht" };
	ScrollView sv;
